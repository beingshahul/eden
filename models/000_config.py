...
settings.modules.pop("vol", None)
settings.modules.pop("inv", None)
settings.modules.pop("member", None)
settings.modules.pop("dvr", None)
settings.modules.pop("budget", None)